    ...
    <main>
      ...
      <div className="max-w-2xl mx-auto px-6 pb-24">
        {!terminado ? (
          ...
          >
            <p className="font-mono text-xs text-neutral-500 mb-6 tracking-widest">
              TU RESULTADO
            </p>
            ...
            <p className="text-neutral-300 leading-relaxed mb-12 max-w-lg mx-auto text-lg">
              {resultado.descripcion}
            </p>

            {/* Desglose de votos */}
            <div className="grid grid-cols-2 gap-3 mb-12 text-left max-w-sm mx-auto">
